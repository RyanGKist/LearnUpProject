...
// arrays to be encoded into the URL-encoded format,
...
// THIS creates our angular-app in "public" directory, and the package.json with Angular
// dependencies (node-modules folder).
// 2. cd INTO "public" DIRECTORY AND RUN:
// a) npm install --save @angular-devkit/core
// b) npm install
// c) ng build --watch
// THIS creates our dist folder and starts Angular
// (Angular watches for any changes in "dist" folder!)
